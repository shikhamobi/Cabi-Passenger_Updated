...
public class PlacesAutoCompleteAdapterNew extends RecyclerView.Adapter<PlacesAutoCompleteAdapterNew.PredictionHolder>
        implements Filterable {

    private static final String TAG = "PlacesAutoCompleteAdapterNew";
    private ArrayList<PlacesAutoCompleteAdapterNew.PlaceAutocomplete> mResultList;
    ...
    public PlacesAutoCompleteAdapterNew(Context context, int resource, GoogleApiClient googleApiClient,
    ...
    private ArrayList<PlacesAutoCompleteAdapterNew.PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
...
//                        prediction.getFullText(new ForegroundColorSpan(0xFFFF0000))));
                resultList.add(new PlacesAutoCompleteAdapterNew.PlaceAutocomplete(prediction.getPlaceId(), prediction.getPrimaryText(null),
    ...
    @Override
    public PlacesAutoCompleteAdapterNew.PredictionHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new PlacesAutoCompleteAdapterNew.PredictionHolder(convertView);
    }


    @Override
    public void onBindViewHolder(PlacesAutoCompleteAdapterNew.PredictionHolder mPredictionHolder, final int i) {
...
//        mPredictionHolder.address2.setText(address1[1]);
    ...
    public PlacesAutoCompleteAdapterNew.PlaceAutocomplete getItem(int position) {
