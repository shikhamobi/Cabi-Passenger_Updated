 ...
 * popuplate listview for locationsearch activity
 */
public class Taxi_searchList_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  //  ArrayList<SearchListData> data;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        vHolder.title.setText(TaxiUtil.SEARCH_LIST_ITEM.get(position).getAdd1());
        vHolder.sub_title.setText(TaxiUtil.SEARCH_LIST_ITEM.get(position).getAdd2());
    }
