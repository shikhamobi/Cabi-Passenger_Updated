...
final class CropWindowHandler {
     ...
     */
    public void setInitialAttributeValues(com.cabipassenger.util.cropper.CropImageOptions options) {
     ...
     */
    public CropWindowMoveHandler getMoveHandler(float x, float y, float targetRadius, com.cabipassenger.util.cropper.CropImageView.CropShape cropShape) {
