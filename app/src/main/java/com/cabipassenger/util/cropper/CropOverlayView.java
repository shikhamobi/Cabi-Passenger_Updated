...
public class CropOverlayView extends View {
     ...
     */
    private com.cabipassenger.util.cropper.CropImageView.Guidelines mGuidelines;

    /**
     * The shape of the cropping area - rectangle/circular.
     */
    private com.cabipassenger.util.cropper.CropImageView.CropShape mCropShape;
    ...
    public void resetCropOverlayView() {
        if (initializedCropWindow) {
            setCropWindowRect(com.cabipassenger.util.cropper.BitmapUtils.EMPTY_RECT_F);
            initCropWindow();
            invalidate();
        }
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public com.cabipassenger.util.cropper.CropImageView.CropShape getCropShape() {
        return mCropShape;
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public void setCropShape(com.cabipassenger.util.cropper.CropImageView.CropShape cropShape) {
        if (mCropShape != cropShape) {
            mCropShape = cropShape;
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17) {
                if (mCropShape == com.cabipassenger.util.cropper.CropImageView.CropShape.OVAL) {
     ...
     */
    public com.cabipassenger.util.cropper.CropImageView.Guidelines getGuidelines() {
        return mGuidelines;
    }
     ...
     */
    public void setGuidelines(com.cabipassenger.util.cropper.CropImageView.Guidelines guidelines) {
    ...
    public void setInitialCropWindowRect(Rect rect) {
        mInitialCropWindowRect.set(rect != null ? rect : com.cabipassenger.util.cropper.BitmapUtils.EMPTY_RECT);
        if (initializedCropWindow) {
            initCropWindow();
            invalidate();
    ...
    private void initCropWindow() {
        ...
        float leftLimit = Math.max(com.cabipassenger.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float topLimit = Math.max(com.cabipassenger.util.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float rightLimit = Math.min(com.cabipassenger.util.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottomLimit = Math.min(com.cabipassenger.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCropWindowHandler.showGuidelines()) {
            ...
            if (mGuidelines == com.cabipassenger.util.cropper.CropImageView.Guidelines.ON) {
                drawGuidelines(canvas);
            } else if (mGuidelines == com.cabipassenger.util.cropper.CropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        float left = Math.max(com.cabipassenger.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float top = Math.max(com.cabipassenger.util.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float right = Math.min(com.cabipassenger.util.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottom = Math.min(com.cabipassenger.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());

        if (mCropShape == com.cabipassenger.util.cropper.CropImageView.CropShape.RECTANGLE) {
            ...
            mPath.reset();
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17 && mCropShape == com.cabipassenger.util.cropper.CropImageView.CropShape.OVAL) {
    ...
    private void drawCorners(Canvas canvas) {
        if (mBorderCornerPaint != null) {
            ...
            float w = cornerWidth / 2 + (mCropShape == com.cabipassenger.util.cropper.CropImageView.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
    ...
    private boolean calculateBounds(RectF rect) {
        ...
        float left = com.cabipassenger.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints);
        float top = com.cabipassenger.util.cropper.BitmapUtils.getRectTop(mBoundsPoints);
        float right = com.cabipassenger.util.cropper.BitmapUtils.getRectRight(mBoundsPoints);
        float bottom = com.cabipassenger.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints);
