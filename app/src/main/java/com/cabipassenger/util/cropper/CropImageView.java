...
package com.cabipassenger.util.cropper;
...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                options = bundle.getParcelable(com.cabipassenger.util.cropper.CropImage.CROP_IMAGE_EXTRA_OPTIONS);
            }
        }
    ...
    public Rect getCropRect() {
        if (mBitmap != null) {
            ...
            return com.cabipassenger.util.cropper.BitmapUtils.getRectFromPoints(points, orgWidth, orgHeight,
    ...
    public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
        ...
        if (mBitmap != null) {
            ...
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                int orgWidth = mBitmap.getWidth() * mLoadedSampleSize;
                int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
                com.cabipassenger.util.cropper.BitmapUtils.BitmapSampled bitmapSampled =
                        com.cabipassenger.util.cropper.BitmapUtils.cropBitmap(getContext(), mLoadedImageUri, getCropPoints(),
                                mDegreesRotated, orgWidth, orgHeight,
                                mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                                reqWidth, reqHeight, mFlipHorizontally, mFlipVertically);
                croppedBitmap = bitmapSampled.bitmap;
            } else {
                croppedBitmap = com.cabipassenger.util.cropper.BitmapUtils.cropBitmapObjectHandleOOM(mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        mFlipHorizontally, mFlipVertically).bitmap;
            }

            croppedBitmap = com.cabipassenger.util.cropper.BitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
        }
    ...
    public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
        ...
        if (bitmap != null && exif != null) {
            com.cabipassenger.util.cropper.BitmapUtils.RotateBitmapResult result = com.cabipassenger.util.cropper.BitmapUtils.rotateBitmapByExif(bitmap, exif);
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            com.cabipassenger.util.cropper.BitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
            float halfWidth = (flipAxes ? com.cabipassenger.util.cropper.BitmapUtils.RECT.height() : com.cabipassenger.util.cropper.BitmapUtils.RECT.width()) / 2f;
            float halfHeight = (flipAxes ? com.cabipassenger.util.cropper.BitmapUtils.RECT.width() : com.cabipassenger.util.cropper.BitmapUtils.RECT.height()) / 2f;
            if (flipAxes) {
            ...
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[0] = com.cabipassenger.util.cropper.BitmapUtils.RECT.centerX();
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[1] = com.cabipassenger.util.cropper.BitmapUtils.RECT.centerY();
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[2] = 0;
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[3] = 0;
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[4] = 1;
            com.cabipassenger.util.cropper.BitmapUtils.POINTS[5] = 0;
            mImageInverseMatrix.mapPoints(com.cabipassenger.util.cropper.BitmapUtils.POINTS);
            ...
            mImageMatrix.mapPoints(com.cabipassenger.util.cropper.BitmapUtils.POINTS2, com.cabipassenger.util.cropper.BitmapUtils.POINTS);
            mZoom /= Math.sqrt(Math.pow(com.cabipassenger.util.cropper.BitmapUtils.POINTS2[4] - com.cabipassenger.util.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.cabipassenger.util.cropper.BitmapUtils.POINTS2[5] - com.cabipassenger.util.cropper.BitmapUtils.POINTS2[3], 2));
            ...
            double change = Math.sqrt(Math.pow(com.cabipassenger.util.cropper.BitmapUtils.POINTS2[4] - com.cabipassenger.util.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.cabipassenger.util.cropper.BitmapUtils.POINTS2[5] - com.cabipassenger.util.cropper.BitmapUtils.POINTS2[3], 2));
            halfWidth *= change;
            halfHeight *= change;

            // calculate the new crop window rectangle to center in the same location and have proper width/height
            com.cabipassenger.util.cropper.BitmapUtils.RECT.set(com.cabipassenger.util.cropper.BitmapUtils.POINTS2[0] - halfWidth, com.cabipassenger.util.cropper.BitmapUtils.POINTS2[1] - halfHeight,
                    com.cabipassenger.util.cropper.BitmapUtils.POINTS2[0] + halfWidth, com.cabipassenger.util.cropper.BitmapUtils.POINTS2[1] + halfHeight);

            mCropOverlayView.resetCropOverlayView();
            mCropOverlayView.setCropWindowRect(com.cabipassenger.util.cropper.BitmapUtils.RECT);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            handleCropWindowChanged(false, false);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mSaveBitmapToInstanceState && imageUri == null && mImageResource < 1) {
            mSaveInstanceStateBitmapUri = imageUri = com.cabipassenger.util.cropper.BitmapUtils.writeTempStateStoreBitmap(getContext(), mBitmap, mSaveInstanceStateBitmapUri);
        }
        if (imageUri != null && mBitmap != null) {
            String key = UUID.randomUUID().toString();
            com.cabipassenger.util.cropper.BitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
        ...
        mImageMatrix.invert(mImageInverseMatrix);
        mImageInverseMatrix.mapRect(com.cabipassenger.util.cropper.BitmapUtils.RECT);

        bundle.putParcelable("CROP_WINDOW_RECT", com.cabipassenger.util.cropper.BitmapUtils.RECT);
        ...
        if (state instanceof Bundle) {
            ...
            if (mBitmapLoadingWorkerTask == null && mLoadedImageUri == null && mBitmap == null && mImageResource == 0) {
                ...
                if (uri != null) {
                    ...
                    if (key != null) {
                        Bitmap stateBitmap = com.cabipassenger.util.cropper.BitmapUtils.mStateBitmap != null && com.cabipassenger.util.cropper.BitmapUtils.mStateBitmap.first.equals(key)
                                ? com.cabipassenger.util.cropper.BitmapUtils.mStateBitmap.second.get() : null;
                        com.cabipassenger.util.cropper.BitmapUtils.mStateBitmap = null;
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            if (mDegreesRotated > 0) {
                mImageMatrix.postRotate(mDegreesRotated, com.cabipassenger.util.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cabipassenger.util.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale the image to the image view, image rect transformed to know new width/height
            float scale = Math.min(width / com.cabipassenger.util.cropper.BitmapUtils.getRectWidth(mImagePoints), height / com.cabipassenger.util.cropper.BitmapUtils.getRectHeight(mImagePoints));
            if (mScaleType == ScaleType.FIT_CENTER || (mScaleType == ScaleType.CENTER_INSIDE && scale < 1) || (scale > 1 && mAutoZoomEnabled)) {
                mImageMatrix.postScale(scale, scale, com.cabipassenger.util.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cabipassenger.util.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }
            ...
            mImageMatrix.postScale(scaleX, scaleY, com.cabipassenger.util.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cabipassenger.util.cropper.BitmapUtils.getRectCenterY(mImagePoints));
            mapImagePointsByImageMatrix();
            ...
            if (center) {
                ...
                mZoomOffsetX = width > com.cabipassenger.util.cropper.BitmapUtils.getRectWidth(mImagePoints) ? 0
                        : Math.max(Math.min(width / 2 - cropRect.centerX(), -com.cabipassenger.util.cropper.BitmapUtils.getRectLeft(mImagePoints)), getWidth() - com.cabipassenger.util.cropper.BitmapUtils.getRectRight(mImagePoints)) / scaleX;
                mZoomOffsetY = height > com.cabipassenger.util.cropper.BitmapUtils.getRectHeight(mImagePoints) ? 0
                        : Math.max(Math.min(height / 2 - cropRect.centerY(), -com.cabipassenger.util.cropper.BitmapUtils.getRectTop(mImagePoints)), getHeight() - com.cabipassenger.util.cropper.BitmapUtils.getRectBottom(mImagePoints)) / scaleY;
            } else {
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            float scaleFactorWidth = mBitmap.getWidth() * mLoadedSampleSize / com.cabipassenger.util.cropper.BitmapUtils.getRectWidth(mImagePoints);
            float scaleFactorHeight = mBitmap.getHeight() * mLoadedSampleSize / com.cabipassenger.util.cropper.BitmapUtils.getRectHeight(mImagePoints);
