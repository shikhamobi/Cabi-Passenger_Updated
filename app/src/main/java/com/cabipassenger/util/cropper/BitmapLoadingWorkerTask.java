...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, BitmapLoadingWorkerTask.Result> {
    ...
    public BitmapLoadingWorkerTask(com.cabipassenger.util.cropper.CropImageView cropImageView, Uri uri) {
        mUri = uri;
    ...
    protected Result doInBackground(Void... params) {
        try {
            if (!isCancelled()) {
                ...
                com.cabipassenger.util.cropper.BitmapUtils.BitmapSampled decodeResult =
                        com.cabipassenger.util.cropper.BitmapUtils.decodeSampledBitmap(mContext, mUri, mWidth, mHeight);

                if (!isCancelled()) {

                    com.cabipassenger.util.cropper.BitmapUtils.RotateBitmapResult rotateResult =
                            com.cabipassenger.util.cropper.BitmapUtils.rotateBitmapByExif(decodeResult.bitmap, mContext, mUri);
