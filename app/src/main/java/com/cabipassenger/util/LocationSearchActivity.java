...
public class LocationSearchActivity extends MainActivity implements Taxi_searchList_adapter.LocationListItemClick, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void Initialize() {
        ...
        Edit_Location.setHintTextColor(CL.getColor(this, R.color.textviewcolor_light));
        Edit_Location.setTextColor(CL.getColor(this, R.color.black));
    ...
    //    Glide.with(this).load(SessionSave.getSession("image_path", this) + "headerLogo.png").diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into((ImageView) findViewById(R.id.header_titleTxt));
        ...
        if (!isFourSquare) {
            ...
            if (!SessionSave.getSession("PLAT", LocationSearchActivity.this).trim().equals("")) {
                Double lat = Double.parseDouble(SessionSave.getSession("PLAT", LocationSearchActivity.this));
                Double lon = Double.parseDouble(SessionSave.getSession("PLNG", LocationSearchActivity.this));
                ...
                new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if (isFourSquare) {
                            ...
                            Edit_Location.setText(TaxiUtil.SEARCH_LIST_ITEM.get(position).getAdd1() + " , " + TaxiUtil.SEARCH_LIST_ITEM.get(position).getAdd2());
...
//            //vaildAddress = "";
//            e.printStackTrace();
//            ShowToast(LocationSearchActivity.this, "Please try again...");
//        }
//    }
...
//            super.onBackPressed();
    ...
    private class ExploreAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            FourSquareService client = new ServiceGenerator(LocationSearchActivity.this, "https://api.foursquare.com/v2/", true).createService(FourSquareService.class);
            Call<Object> coreResponse = client.requestExplore(formattedDate,
                    SessionSave.getSession("PLAT", LocationSearchActivity.this) + "," + SessionSave.getSession("PLNG", LocationSearchActivity.this), params[0], SessionSave.getSession("android_foursquare_api_key", LocationSearchActivity.this));
